...
Ce _Guide_ est un aide-mémoire pour créer du contenu dans l'[Université Virtuelle][UV] (UV), plateforme officielle d'apprentissage de l'[Université libre de Bruxelles][ULB] (ULB), basé sur le LMS [Moodle](Moodle) version 4.x (sept 2023, revu mai 2026). 
